...
const translateToVietnamese = async () => {
  ...
  try {
    ...
    const apiUrl = `https://translate.googleapis.com/translate_a/single?client=gtx&sl=ko&tl=vi&dt=t&q=${encodeURIComponent(koreanText.value)}`
    ...
    if (data && data[0] && data[0][0]) {
      vietnameseText.value = data[0][0][0]
    } else {
...
// 노트 추가
const addNote = () => {
  if (!koreanText.value.trim() || !vietnameseText.value.trim()) {
    snackbarStore.showError('한국어와 베트남어를 모두 입력해주세요')
    return
  }
  ...
  const newNote = {
    ...
    vietnamese: vietnameseText.value.trim(),
...
<template>
  <div class="common-page">
    ...
    <main class="learning-note-content">
      <div class="common-container-lg">
        <!-- 헤더 -->
        <div class="page-header common-animate-fade-in">
          ...
          <div class="header-content">
            ...
            <div class="header-text">
              <h1 class="common-headline1">학습 노트</h1>
              <p class="common-body1">오늘 배운 내용을 베트남어로 번역하며 정리해보세요</p>
            </div>
          </div>
        </div>

        <!-- 통계 카드 -->
        <div class="stats-section common-animate-slide-up">
        ...
        <!-- 카테고리 필터 -->
        <div class="category-filter-section common-animate-slide-up">
        ...
        <!-- 노트 추가 버튼 -->
        <div class="add-note-section common-animate-slide-up">
        ...
        <div class="notes-grid">
          ...
          >
            ...
            <div class="note-content">
              ...
              <div class="note-section vietnamese-section">
                <div class="note-lang-label">
                  <span class="flag-icon">🇻🇳</span>
                  <span class="lang-text">Tiếng Việt</span>
                </div>
                <p class="note-text vietnamese-text">{{ note.vietnamese }}</p>
              </div>
            </div>
          </div>
          ...
          <v-card-title class="pa-6 pb-4">
            <div class="dialog-header">
              ...
              <div>
                ...
                <p class="common-body2 text-grey-600">배운 내용을 기록하고 베트남어로 번역해보세요</p>
              </div>
            </div>
          </v-card-title>
          ...
          <v-card-actions class="pa-6 pt-0">
            <div class="dialog-actions">
              ...
              <CommonVButton
                common-variant="primary"
                @click="addNote"
                :disabled="!koreanText.trim() || !vietnameseText.trim()"
                size="large"
